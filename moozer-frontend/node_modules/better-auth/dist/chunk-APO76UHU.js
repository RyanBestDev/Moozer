import { createAuthEndpoint, sessionMiddleware, APIError, createAuthMiddleware } from './chunk-HMECAGV7.js';
import { parseCookies, setSessionCookie, deleteSessionCookie, parseSetCookieHeader } from './chunk-WBFH3ZYN.js';
import { z } from 'zod';
      ...
      after: [
        {
          ...
          handler: createAuthMiddleware(async (ctx) => {
            const headers = ctx.context.returned instanceof APIError ? ctx.context.returned.headers : ctx.responseHeader;
