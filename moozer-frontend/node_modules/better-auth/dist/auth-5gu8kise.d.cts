...
import { ContextTools, APIError, EndpointOptions, CookieOptions, Endpoint, EndpointResponse } from 'better-call';
import * as zod from 'zod';
import { ZodSchema, z } from 'zod';
import { d as LiteralUnion, L as LiteralString, D as DeepPartial, U as UnionToIntersection, S as StripEmptyObjects, O as OmitId, P as PrettifyDeep, b as Prettify, E as Expand } from './helper-Bi8FQwDD.cjs';
import { O as OAuthProvider, S as SocialProviders, b as SocialProviderList } from './index-IbeXrsdr.cjs';
...
declare const createInternalAdapter: (adapter: Adapter, ctx: {
    ...
    createSession: (userId: string, request: Request | Headers | undefined, dontRememberMe?: boolean, override?: Partial<Session> & Record<string, any>, overrideAll?: boolean) => Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        userId: string;
...
export { parseSetCookieHeader as $, type Adapter as A, type BetterAuthOptions as B, type SecondaryStorage as C, type FilterActions as D, type InferSessionAPI as E, type FilteredAPI as F, type GenericEndpointContext as G, type HookEndpointContext as H, type InferOptionSchema as I, type InferAPI as J, type KyselyDatabaseType as K, createCookieGetter as L, type Models as M, getCookies as N, type BetterAuthCookies as O, setCookieCache as P, setSessionCookie as Q, type RateLimit as R, type Session as S, deleteSessionCookie as T, type User as U, type Verification as V, type Where as W, parseCookies as X, type EligibleCookies as Y, getSessionCookie as Z, getCookieCache as _, BASE_ERROR_CODES as a, changeEmail as a$, type LogLevel as a0, levels as a1, shouldPublishLog as a2, type Logger as a3, type LogHandlerParams as a4, createLogger as a5, logger as a6, type FieldAttribute as a7, type FieldType as a8, createInternalAdapter as a9, mergeSchema as aA, getEndpoints as aB, router as aC, signInSocial as aD, signInEmail as aE, callbackOAuth as aF, getSession as aG, getSessionFromCtx as aH, sessionMiddleware as aI, freshSessionMiddleware as aJ, listSessions as aK, revokeSession as aL, revokeSessions as aM, revokeOtherSessions as aN, signOut as aO, forgetPassword as aP, forgetPasswordCallback as aQ, resetPassword as aR, createEmailVerificationToken as aS, sendVerificationEmailFn as aT, sendVerificationEmail as aU, verifyEmail as aV, updateUser as aW, changePassword as aX, setPassword as aY, deleteUser as aZ, deleteUserCallback as a_, type InternalAdapter as aa, type FieldAttributeConfig as ab, createFieldAttribute as ac, type InferValueType as ad, type InferFieldsOutput as ae, type InferFieldsInput as af, type InferFieldsInputClient as ag, type PluginFieldAttribute as ah, type InferFieldsFromPlugins as ai, type InferFieldsFromOptions as aj, type BetterAuthDbSchema as ak, getAuthTables as al, accountSchema as am, userSchema as an, sessionSchema as ao, verificationSchema as ap, parseOutputData as aq, getAllFields as ar, parseUserOutput as as, parseAccountOutput as at, parseSessionOutput as au, parseInputData as av, parseUserInput as aw, parseAdditionalUserInput as ax, parseAccountInput as ay, parseSessionInput as az, type AuthPluginSchema as b, error as b0, ok as b1, signUpEmail as b2, listUserAccounts as b3, linkSocialAccount as b4, unlinkAccount as b5, originCheckMiddleware as b6, originCheck as b7, type HookBeforeHandler as c, type HookAfterHandler as d, type BetterAuthPlugin as e, type InferPluginErrorCodes as f, createAuthMiddleware as g, createAuthEndpoint as h, type AuthEndpoint as i, type AuthMiddleware as j, type Auth as k, type AuthContext as l, type InferUser as m, type InferSession as n, optionsMiddleware as o, type WithJsDoc as p, betterAuth as q, type AdditionalUserFieldsInput as r, type AdditionalUserFieldsOutput as s, type AdditionalSessionFieldsInput as t, type AdditionalSessionFieldsOutput as u, type InferPluginTypes as v, type Account as w, init as x, type AdapterSchemaCreation as y, type AdapterInstance as z };
