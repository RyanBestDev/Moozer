...
var orgMiddleware = chunkFTP5NPIZ_cjs.createAuthMiddleware(async (ctx) => {
  return {};
});
var orgSessionMiddleware = chunkFTP5NPIZ_cjs.createAuthMiddleware(
  {
...
var createInvitation = (option) => chunkFTP5NPIZ_cjs.createAuthEndpoint(
...
var acceptInvitation = chunkFTP5NPIZ_cjs.createAuthEndpoint(
...
var rejectInvitation = chunkFTP5NPIZ_cjs.createAuthEndpoint(
...
var cancelInvitation = chunkFTP5NPIZ_cjs.createAuthEndpoint(
...
var getInvitation = chunkFTP5NPIZ_cjs.createAuthEndpoint(
...
var addMember = () => chunkFTP5NPIZ_cjs.createAuthEndpoint(
  ...
  async (ctx) => {
    const session = ctx.body.userId ? await chunkFTP5NPIZ_cjs.getSessionFromCtx(ctx).catch((e) => null) : null;
...
var removeMember = chunkFTP5NPIZ_cjs.createAuthEndpoint(
  ...
  async (ctx) => {
    ...
    const isOwner = toBeRemovedMember.role === (ctx.context.orgOptions?.creatorRole || "owner");
    if (isOwner) {
      throw new betterCall.APIError("BAD_REQUEST", {
...
var updateMemberRole = (option) => chunkFTP5NPIZ_cjs.createAuthEndpoint(
  ...
  async (ctx) => {
    ...
    const creatorRole = ctx.context.orgOptions?.creatorRole || "owner";
    if (toBeUpdatedMember.role === creatorRole || ctx.body.role === creatorRole && member.role !== creatorRole) {
      return ctx.json(null, {
        status: 400,
        body: {
    ...
    const hasPermission = role2.authorize({
      member: ["update"]
    });
...
var getActiveMember = chunkFTP5NPIZ_cjs.createAuthEndpoint(
...
var leaveOrganization = chunkFTP5NPIZ_cjs.createAuthEndpoint(
  "/organization/leave",
  {
    method: "POST",
    body: zod.z.object({
    ...
    use: [chunkFTP5NPIZ_cjs.sessionMiddleware, orgMiddleware]
  },
  async (ctx) => {
    const session = ctx.context.session;
...
var createOrganization = chunkFTP5NPIZ_cjs.createAuthEndpoint(
  "/organization/create",
  {
    method: "POST",
    body: zod.z.object({
...
var updateOrganization = chunkFTP5NPIZ_cjs.createAuthEndpoint(
  "/organization/update",
  {
    method: "POST",
    body: zod.z.object({
...
var deleteOrganization = chunkFTP5NPIZ_cjs.createAuthEndpoint(
  "/organization/delete",
  {
    method: "POST",
    body: zod.z.object({
...
var getFullOrganization = chunkFTP5NPIZ_cjs.createAuthEndpoint(
...
var setActiveOrganization = chunkFTP5NPIZ_cjs.createAuthEndpoint(
...
var listOrganizations = chunkFTP5NPIZ_cjs.createAuthEndpoint(
  "/organization/list",
  {
    method: "GET",
    use: [orgMiddleware, orgSessionMiddleware],
...
var organization = (options) => {
  ...
  const api = shimContext(endpoints, {
    ...
    getSession: async (context) => {
      return await chunkFTP5NPIZ_cjs.getSessionFromCtx(context);
    }
  });
  return {
    id: "organization",
    endpoints: {
      ...api,
      hasPermission: chunkFTP5NPIZ_cjs.createAuthEndpoint(
