...
import { U as User, S as Session, I as InferOptionSchema, l as AuthContext, H as HookEndpointContext } from '../auth-5gu8kise.cjs';
import { z } from 'zod';
import 'kysely';
...
declare const admin: <O extends AdminOptions>(options?: O) => {
    ...
    endpoints: {
        ...
        setUserPassword: {
            <C extends [better_call.Context<"/admin/set-user-password", {
                method: "POST";
                body: z.ZodObject<{
