...
import { l as AuthContext, U as User } from '../auth-5gu8kise.cjs';
import { z } from 'zod';
import { O as OAuthProvider, a as OAuth2Tokens } from '../index-IbeXrsdr.cjs';
import 'kysely';
...
declare const genericOAuth: (options: GenericOAuthOptions) => {
    ...
    endpoints: {
        ...
        oAuth2LinkAccount: {
            <C extends [better_call.Context<"/oauth2/link", {
                method: "POST";
                body: z.ZodObject<{
                    providerId: z.ZodString;
