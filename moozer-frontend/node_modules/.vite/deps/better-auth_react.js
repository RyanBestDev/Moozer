...
var getClientConfig = (options) => {
  ...
  const baseURL = getBaseURL(options == null ? void 0 : options.baseURL);
  ...
  const $fetch = createFetch({
    ...
    plugins: (options == null ? void 0 : options.disableDefaultFetchPlugins) ? [...((_b = options == null ? void 0 : options.fetchOptions) == null ? void 0 : _b.plugins) || [], ...pluginsFetchPlugins] : [
      redirectPlugin,
      ...((_c = options == null ? void 0 : options.fetchOptions) == null ? void 0 : _c.plugins) || [],
      ...pluginsFetchPlugins
    ]
  });
  ...
  for (const plugin of plugins) {
    if (plugin.getAtoms) {
      Object.assign(pluginsAtoms, (_d = plugin.getAtoms) == null ? void 0 : _d.call(plugin, $fetch));
    }
  ...
  for (const plugin of plugins) {
    if (plugin.getActions) {
      Object.assign(pluginsActions, (_e = plugin.getActions) == null ? void 0 : _e.call(plugin, $fetch, $store));
    }
  }
  return {
    pluginsActions,
...
function useStore(store, { keys, deps = [store, keys] } = {}) {
  ...
  let subscribe = (0, import_react.useCallback)(
    (onChange) => ((keys == null ? void 0 : keys.length) || 0) > 0 ? listenKeys(store, keys, emit(snapshotRef, onChange)) : store.listen(emit(snapshotRef, onChange)),
    deps
  );
